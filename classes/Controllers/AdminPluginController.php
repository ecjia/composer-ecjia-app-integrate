...
class AdminPluginController extends ecjia_admin
{
	...
	public function __construct()
    {
		...
		RC_Script::enqueue_script('integrate_list', RC_App::apps_url('statics/js/integrate_list.js', $this->__FILE__), array(), false, false);

        RC_Script::localize_script('integrate_list', 'js_lang_integrate_list', config('app-integrate::jslang.integrate_page'));
