...
class IntegrateServiceProvider extends  AppParentServiceProvider
{
    ...
    {
        $this->royalcms->singleton('ecjia.integrate', function($royalcms) {
    ...
    {
        $this->royalcms->singleton('ecjia.integrate.plugin', function($royalcms) {
    ...
    {
        return [
            'ecjia_integrate' => 'Ecjia\App\Integrate\Facades\EcjiaIntegrate',
        ];
    }
